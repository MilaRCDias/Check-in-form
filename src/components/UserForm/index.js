              ...
              <Form>
                ...
                {["Austria", "Greece"].includes(userNationality) ? (
                  <Box m={4}>
                    ...
                    />
                    {errors.passportExpireDate && touched.passportExpireDate ? (
                ...
                {userNationality === "Greece" ? (
                  <Box>
                    <Box m={4}>
                      ...
                      />
                      {errors.passportDateIssue && touched.passportDateIssue ? (
                        <div className={style.error}>
                    ...
                    <Box m={4}>
                      ...
                      />
                      {errors.passportCityIssue && touched.passportCityIssue ? (
                        <div className={style.error}>
